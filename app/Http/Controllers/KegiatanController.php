...
class KegiatanController extends Controller
{
    ...
    public function index()
    {
        $kegiatan = DB::table('kegiatan')
            ...
            ->join('paket', 'kegiatan.id_paket', 'paket.id_paket')
            ->join('kupon', 'kegiatan.id_kupon', 'kupon.id_kupon')
            ->get();
        $title = 'Data Kegiatan';
    ...
    public function create()
    {
        ...
        return view('kegiatan.create', compact('kategori_kegiatan','paket','kupon', 'sub_kategori_kegiatan', 'kegiatan', 'status_kegiatan', 'publish_kegiatan', 'title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $kegiatan->id_paket = $request->id_paket;
        $kegiatan->id_kupon = $request->id_kupon;
    ...
    public function edit(Kegiatan $kegiatan)
    {
        ...
        $kupon = Kupon::all();
        $title = 'Edit Kegiatan';
        return view('kegiatan.edit', compact('kategori_kegiatan','paket','kupon', 'sub_kategori_kegiatan', 'title', 'status_kegiatan', 'publish_kegiatan', 'kegiatan'));
    }
