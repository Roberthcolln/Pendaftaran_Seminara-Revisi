    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('bukti_user.store') }}" class="row g-3" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    
                    <div class="form-group mb-2 col-md-4">
                        <label for="">Nama Peserta</label>
                        <input type="text" class="form-control" placeholder="Masukkan nama disini..." name="nama" value="{{ old('nama') }}">
                    </div>
                    <div class="form-group mb-2 col-md-4">
